...
import { fillTableAirdrop } from "./controller/get-free-d1.js"; 
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function filterData() {
        ...
        const selectedTasks = Array.from(dropdown.querySelectorAll('input[type="checkbox"][value="daily"], input[type="checkbox"][value="testnet"], input[type="checkbox"][value="game"], input[type="checkbox"][value="social"]'))
            .filter(checkbox => checkbox.checked)
            .map(checkbox => checkbox.value.trim());
